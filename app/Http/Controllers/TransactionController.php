...
class TransactionController extends Controller
{
	...
	public function getUserTransactionsLastMonth($userId) {
		$date = Carbon::now();

		$lastMonth = $date->subMonth()->format('F');

		return $this->getUserTransactionByMonth($userId, $lastMonth);
	}

	public function getUserTransactionByMonth($userId, $month) {
	  ...
	  try {
		 ...
		 $firstDayofMonth = Carbon::parse($month)->startOfMonth()->toDateString();
		 ...
		 ->where('transactions.user_id', $userId)->get();
	...
	public function getFlowsLastMonth($id) {
		...
		try {
			...
			$firstDayofMonth = Carbon::parse($lastMonth)->startOfMonth()->toDateString();
			$lastDayofMonth = Carbon::parse($lastMonth)->endOfMonth()->toDateString();
	...
	public function getUserTransactionsByMonthYear($id, $month, $year) {
